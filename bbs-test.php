      ...
      <div class="container">
        ...
        <div class="form">
            ...
            <form class="form-inline" action="" method="get">
              <input class="form-control mr-sm-2" id="search" name="search" type="search" placeholder="search" aria-label="search" value="<?php echo $search_value ?>">
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              <?php if($page > 1): ?>
                <li class="page-item"><a class="page-link" href="../bbs?page=<?php print($page-1); ?>">前のページへ</a></li>
              <?php endif; ?>

              <?php if($page < $maxPage): ?>
                <li class="page-item"><a class="page-link" href="../bbs?page=<?php print($page+1); ?>">次のページへ</a></li>
              <?php endif; ?>
            </ul>
          </nav>
            </div>
