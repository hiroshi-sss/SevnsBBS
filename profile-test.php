      ...
      <div class="container">
        <div class="form">
          ...
          <div class="card" style="width: 20rem;">
            ...
            <form name="mainForm" id="mainForm" action="" method="post" class="profile_ajax" data-profileid="<?php print($_SESSION['id']); ?>" enctype="multipart/form-data">
            <img src="<?php
            ...
            if (file_exists($path)) {
             ...
             ?>" class="card-img-top button_area" alt="...">

             <?php var_dump($path); ?>

             <div class="card-body button_area icons" id="icons">
               <img src="<?php
               $path = 'member_icon/' . htmlspecialchars($member['picture'], ENT_QUOTES);
               if (file_exists($path)) {
                 print($path);
                ...
                <br>
                <input type="hidden" name="img_delete" value="<?php print($member['picture']); ?>">
                <button type="button" id="img-dlt-btn" class="btn btn-outline-dark btn-block">画像を削除</button>
            ...
            <div class="card-footer text-muted">
              アカウント作成日：<br>[ <?php print(date('Y年m月d日',  strtotime($date))); ?> ]
            </div>
          ...
          <input type="hidden" id="my_image" value="my_image">
          </div>
        </div>
      </div>
