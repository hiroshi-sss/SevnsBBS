...
if(!empty($_POST)) {
  ...
  header('Location: ../profile?=' . $member['login_id']);
  exit();
}
      ...
      <div class="container">
        <div class="form">
          <form action="" method="post">
            ...
            <div><button type="button" class="btn btn-light" onclick="location.href='../account?action=rewrite'">書き直す</button> | <button type="submit" class="btn btn-primary" value="">登録する</button></div>
          </form>
        </div>
      </div>
      <?php var_dump($member); ?>
