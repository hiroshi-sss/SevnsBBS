...
$memberss = $db->prepare('SELECT * FROM members WHERE id=?');
$memberss->execute(array($_SESSION['id']));
$members = $memberss->fetch();
      ...
      <div class="container">
        <div class="form">
          ...
          <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="control">
                    <label for="name">新しいニックネーム</label>
                  ...
                  <div class="control">
                    <label for="login_id">新しいログイン用ID <span class="badge badge-pill badge-danger">*英数字</span></label>
                  ...
                  <div class="control">
                    <label for="password">新しいパスワード <span class="badge badge-pill badge-danger">*4桁以上</span></label>
                  ...
                  <div class="form-group">
                      <label for="my_image">新しいアイコン用画像</label>
